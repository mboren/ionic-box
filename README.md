This is a fork of a fork of the original Ionic Box project. I'm just adding a few bits that I use, but probably none of my changes will be generally applicable.
